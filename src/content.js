// 本文は Aozora Bunko（青空文庫）収録の石波杏訳『老人と海』
// （アーネスト・ヘミングウェイ THE OLD MAN AND THE SEA, 1952 の日本語訳、2015年7月公開）
// クリエイティブ・コモンズ 表示 2.1 日本 ライセンス（CC BY 2.1 JP）の下で使用しています。
// https://www.aozora.gr.jp/cards/001847/card57347.html
// https://creativecommons.org/licenses/by/2.1/jp/
// ルビ（読み仮名）は省略し、訳者あとがき・参考文献一覧はここには含めていません。

export const title = "老人と海";
export const originalTitle = "THE OLD MAN AND THE SEA";
export const author = "アーネスト・ヘミングウェイ";
export const authorRoman = "Ernest Hemingway";
export const translator = "石波杏";

// palette: 周辺の空(海)の色調キー。effects.js の PALETTES と対応する。
// swell: そのシーンの文章がどれだけ波にたゆたうかの強さ。
export const chapters = [
  {
    ...
    paragraphs: [
      ...
      "「覚えてるよ。尻尾でバタバタ跳ね回って、船梁をぶち壊したんだ。棍棒でぶん殴った時の音まで覚えてる。僕はサンチャゴに舳先のほうへ突き飛ばされて、濡れたロープのそばで、船全体が震えるのを感じてたんだよ。サンチャゴが丸太をぶち割るみたいに魚を棍棒で叩いて、すごい音がした。そこらが甘ったるい血の臭いでいっぱいになったんだ。」",
      ...
      "二人は船から道具を取り出した。老人はマストを肩にかつぎ、少年は木箱と手鉤と柄つきの銛を運んだ。木箱には、撚りの強い茶色のロープが渦になって収まっていた。餌にする魚を入れた箱は、棍棒と一緒に船尾のほうに残しておいた。棍棒は、大きな魚を船べりまで引き寄せた時、魚が暴れるのを鎮めるために使うものだ。",
      ...
      "二人は、老人の棲家である粗末な小屋まで一緒に歩き、開け放してある入り口から中へ入った。老人は、帆を巻きつけたマストを壁に立てかけ、少年はそのそばに木箱や他の道具を置いた。マストは、小屋に一つしかない部屋の、奥行きと同じくらい長かった。小屋は、グアノと呼ばれるダイオウヤシの、若芽を包む硬い苞でできていた。中には、ベッド、テーブル、椅子が一脚あり、土間には炭を使って炊事が出来る場所もある。丈夫な繊維からなるグアノの葉を伸ばして重ねて作られた褐色の壁には、多色刷りの絵画が二枚掛けられていた。『イエスの聖心』、そして『コブレの聖母マリア』。どちらも妻の形見だった。かつては、色あせた妻の写真もその壁に飾られていたが、見るたびに老人はあまりにも淋しい気持ちになったので、取り外してしまった。今ではその写真は、部屋の隅にある棚の、洗濯したシャツの下にしまってある。",
      "「何を食べるの？」少年が尋ねた。",
      "「魚の混ぜ飯がある。食べるか？」",
      "「僕は家で食べるよ。火を起こそうか？」",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "老人はすぐに眠りに落ち、アフリカの夢を見た。彼はまだ少年だった。広がる金色の砂浜、白く輝く砂浜。目を傷めそうなほど白い。高々とそびえる岬、巨大な褐色の山々。最近の彼は毎晩、この海岸で時を過ごすのだった。彼は夢の中で、打ち寄せる波の音に耳を傾け、その波をかき分けて進む先住民たちの舟を眺めていた。眠っていても、甲板からタールやマイハダの匂いが漂い、朝になれば陸風がアフリカの香りを運んでくるのだ。",
      "いつもなら、陸風の香りで目を覚まし、着替えて少年を起こしに出かける。しかし、今夜は陸風が匂うのが早すぎた。夢の中でもそれが早すぎると分かったから、老人は、夢を見続けることにした。海に屹立する島々の白い頂を眺め、カナリア諸島のいくつもの港や停泊地を通り過ぎていく。",
      ...
      "老人はゆっくりとコーヒーを飲んだ。彼の今日一日の食事はこれで全てだ。だから飲まなければいけない。ずいぶん前から、食べるというのは彼にとって面倒なことになっていた。弁当を持っていくことはなかった。船の舳先に、水を入れた瓶を一本置いておけば、一日それだけで十分だった。",
      ...
      "時々、どこかの船から話し声がすることもあったが、ほとんどの船は静かで、ただオールの音だけが聞こえてきた。港の出口を越えると、船たちはばらばらに拡がっていった。それぞれが魚の居場所にあたりをつけて大海へ向かうのだ。老人は遠くまで行くつもりだった。彼は陸の匂いを後にして、朝の海の清々しい匂いの中を漕いで行った。水の中で、ホンダワラとおぼしき海藻が燐光を放っているのが見えた。深さが突然七〇〇尋にもなっているこの辺りを、漁師たちは「大井戸」と呼ぶ。海底の急斜面に海流がぶつかって渦を作り、あらゆる種類の魚が集まる場所だった。小エビや小魚、時には深い穴の中にヤリイカの群れがいることもある。それらが夜になって海面近くまで上がってくると、泳ぎ回る魚たちの格好の餌になるのだ。",
      ...
      "老人は弛みなく漕いだ。自分のペースを保っている分には、それほど力を込める必要もない。時に潮の流れが渦巻いているのを除けば、海面は静かだった。老人は船を動かす仕事の三分の一を流れに任せた。明るくなり始めた頃には、予定よりずっと遠くまで来ていた。",
      "この一週間は大井戸で粘ったが、収穫はなかった。今日はカツオやビンナガマグロの群れがいる辺りを狙ってやろう、その群れの中にでかい奴がいるかもしれん。彼はそう考えていた。",
      "夜が明けきる前に老人は仕掛けを下ろし、船の動きを流れに預けた。一つ目の仕掛けは四〇尋まで沈めた。二つ目は七五尋、三つ目と四つ目はさらに海中深く、一〇〇尋と一二五尋までロープが届いている。それぞれのロープの先では、餌となる小魚が頭を下にして鉤の軸に体を貫かれ、きつく縫い刺しにされていた。鉤の先の、小魚の体から突き出た部分は、曲がっている部分も先っぽも、新鮮なイワシで覆われていた。イワシたちは眼を串刺しにされ、突き出た鋼鉄の棒の先に咲いた半円形の花びらのようだった。大きな魚がどこから近づいても、すばらしい匂いと味を感じられるはずだ。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "ちょうどその時、前方の空に、黒く長い翼を持つ軍艦鳥が旋回するのが見えた。軍艦鳥は、翼を後ろにそらせて、斜めに急降下した。そしてまた旋回を始めた。",
      ...
      "老人はオールを船内におさめると、舳先から細いロープを取り出した。それには針金の鉤素と、中くらいの大きさの釣り針がついていた。老人は、そこにイワシを一匹つけ、船べりから投げた。そしてロープの端を船尾のリングボルトにしっかり結びつけた。それから別のロープにも餌をつけ、こちらは巻いたまま舳先に置いておいた。彼は再び漕ぎ始め、黒く長い翼の鳥が水面近くで飛び回るのを見つめていた。",
      ...
      "トビウオが次々と海面から跳ね、鳥がむなしく飛び回る様子を、老人はじっと見ていた。彼は考えた。シイラの大群には逃げられたな、奴らの泳ぎはかなり速いし、もうずいぶん遠い。だが、はぐれた奴が釣れることもあるだろう。それに、大物が奴らの後を泳いでいるかもしれん。俺の狙う大魚は、どこかに必ずいるんだ。",
      ...
      "「アグア・マーラか」彼は言った。「娼婦め」",
      "老人はオールを軽く押し、そこで海の中をのぞきこんだ。触手と同じ色の小魚たちが、触手の間や、漂う泡の陰を泳ぎ回っていた。小魚たちは毒に対して免疫があるのだ。しかし、人間はその免疫を持たない。もしも触手がロープに絡み、ぬるぬると紫色にまとわりつけば、ロープを引っ張る老人の手や腕に、みみず腫れと痛みをもたらすことになるだろう。ツタウルシの毒でかぶれるのと似ているが、アグア・マーラの毒はもっと速く、鞭で打つように人を襲う。",
      ...
      "「あの鳥にはずいぶん世話になる」老人は言った。その時、彼の足の下で輪にしてあったロープが、船尾のほうからぐっと引っ張られた。老人はオールから手を離した。ロープを堅く握って手繰り寄せると、小さなマグロが体を震わせながら引っ張っている力を感じる。震える力は、ロープを引けば引くほど強くなっていった。水の中から、魚の青い背中と金色のわき腹が見えてきた。そして彼は、船べりを越えて魚を船に引き入れた。魚は太陽に照らされ、引き締まった弾丸のような体をして、大きく無表情な目を見開きながら、良い形のよく動く尾を素早く震わせ、船板にその生命を打ちつけている。老人は優しさから、魚の頭を叩き、蹴飛ばした。魚は船尾の陰に飛び、それでも震え続けている。",
      "「ビンナガだ」老人は声に出して言った。「いい餌になるぞ。十ポンドはありそうだ」",
      "声に出して独り言を言うようになったのはいつからだったか、彼は覚えていなかった。昔は、一人のときには歌を口ずさんだものだ。魚槽付小型船や亀獲り船で、寝ずに舵取りの番をするような時など、たまに歌を唄っていた。老人が独り言を言うようになったのはきっと、少年が去って、一人になってからだろう。しかし定かではなかった。少年と一緒に漁に出ていた頃は、必要な時以外ほとんど会話をしなかった。二人が話すのは、夜とか、悪天候で船を出せないときだ。海では不必要に喋らないのが美徳だったし、老人はいつでもその美徳を尊重していた。しかし今、彼は自分が思ったことをたびたび声に出す。それで困る者もいないからだ。",
      "「べらべら喋っているのを誰かが聞いたら、俺のことを気違いだと思うだろうな」老人は声に出して言った。「だが気違いじゃない。だから構わないんだ。金持ちの奴らなどラジオを持っていて、船の中で喋らせるどころか、野球の実況までさせてるじゃないか」",
      "今は野球のことを考える時じゃない、彼は思った。考えるべきは、たった一つ。そのたった一つのために、俺は生まれてきたのだ。この群れのまわりに、大物がいるかもしれない。まだ、餌を追うビンナガの群れから逸れた一匹を釣っただけだ。しかし群れはもう遠く、速い。今日は水面に見える全てが、北東に向かって高速で動いているようだ。時間帯のせいか。それとも、俺の知らない、天気が変わる前兆だろうか。",
      "緑色の海岸線はもう見えない。見えるのは、青い丘の頂がまるで雪をかぶったかのように白く光る様子と、その上に高い雪山のように広がる雲だけだった。海はとても暗く、差し込む光が水の中にプリズムを作っていた。無数の斑点のようなプランクトンたちの姿は、高く昇った日の光でかき消されている。老人の目に映るのは、青い水の中に深々と延びるプリズムと、一マイルの深さまで真っ直ぐに垂らされている彼のロープだけだった。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "指からロープを滑らせながら、彼は左手を伸ばした。控えのロープ二巻を、別の控えの二巻にしっかりと結ぶ。準備は整った。これで、今持っているロープに加え、四〇尋の控えが三巻も用意できたのだ。",
      "「もうちょっと食うんだ」老人は言った。「しっかり食らいつけ」",
      "そうだ、鉤の尖端がお前の心臓に突き刺さって、お前を殺してしまうくらいにな。気楽に上がって来いよ。そうしたら、銛を打ち込んでやるからな。さあ、いいぞ。準備はどうだ。もう十分食べただろう？",
      "「そら！」彼は大声を出して、ロープを両手で思い切り引き、一ヤードほど手繰り寄せる。そして、腕に全力を込めながら体重を乗せ、両腕を交互に振るようにしてぐいぐいと引っぱる。",
      "何も起こらなかった。魚はただゆっくりと遠ざかっていく。老人には、一インチたりとも引き上げることはできなかった。老人はロープを背中に回して支えた。大物用の丈夫なロープがぴんと張り、水の粒が飛び散る。やがて水中のロープから、じりじりと鈍い音がしてきた。彼はロープを握って船梁に寄りかかり、体を反らせて引きに抵抗した。船はゆっくりと、北西の方角へ動き始めた。",
      "魚は弛みなく泳ぐ。穏やかな海を、船は魚とともにゆっくり移動していく。他の餌はまだ水の中だが、どうしようもなかった。",
      "「あの子がいてくれたらなあ」老人は声に出して言った。「魚に引っ張られて、これじゃ俺が曳航用の繋ぎ柱だ。ロープを固定しようと思えばできるが、そうしたら奴に切られちまうだろう。なんとしても、逃がすわけにはいかん。引っ張りたいならもっと伸ばしてやればいい。ありがたいことに、奴は移動してはいるが深く潜ろうとはしていない」",
      ...
      "魚を引っ掛ける前に深くかぶり直した麦わら帽で、額が痛んだ。のどもひどく渇いていた。彼は膝をついて、ロープを引っ張らないように注意しながらできるだけ舳先に近いところまで這って行き、片手を伸ばして水の瓶を取った。栓を取り、少しだけ飲む。そして舳先に寄りかかって休んだ。横たえてあるマストと帆の上に腰を下ろして、ただ耐えること以外考えないようにしていた。",
    ]
  },
  {
    palette: "night",
    ...
    paragraphs: [
      ...
      "老人が星を見て判断した限りでは、その夜、魚は進む方向を全く変えなかった。太陽が沈むと寒くなった。汗は乾き、老人の背中や腕や老いた脚を冷やす。彼は昼の間に、餌箱を覆っていた袋を取り、日なたに広げて乾かしておいた。日が沈んでからそれを首に巻いて、背中のほうに垂らし、肩にかかっているロープの下に慎重に差し入れた。これで袋がクッションになる。そうして、前向きに舳先へ寄りかかればだいぶ楽になる。実際には、多少我慢しやすいという程度だったのだが、彼にはずいぶん楽になったように思えた。",
      "俺には何もできない、が、奴にも何もできない。奴がこのまま泳ぎ続ける限りは、変わらないだろう。老人はそう考えていた。",
      "彼は一度立ち上がって、船端から小便をした。そして星を見て進路を確認した。肩からまっすぐに水中に走るロープは、燐光を放つ筋のように見える。船の動く速度は落ちていた。今やハバナの灯りはさほど強くなく、海流が彼らを東のほうへ運んだのが分かった。もしもハバナの光が見えなくなったら、さらに東のほうに曲がったということだ。もし魚が針路を変えなければ、まだしばらくは光が見えるはずだからな、そう彼は考えた。大リーグの今日の試合はどうなったろう。ラジオで聴けたら最高なんだが。しかし彼はすぐ思い直した。今はただ一つの事に集中しなければ。自分のやることだけを考えるんだ。下らないことをしてる場合じゃない。",
      ...
      "老人は、つがいのカジキのうち一匹を引っ掛けた時のことを思い出した。カジキのオスは、餌を見つけると必ずメスに先に食べさせる。だから引っ掛かったのはメスのほうで、パニックを起こして自暴自棄な暴れ方をしたので、すぐに力を使い果たしてしまった。オスのほうはその間ずっとメスのそばにいて、ロープの前を横切ったり、海面を一緒に旋回したりしていた。オスがあまり近づくので、老人は、尾でロープを切られてしまわないか心配した。その尾は大鎌のように鋭く、大きさも形もほとんど大鎌そのものだったのだ。老人はメスの体に手鉤を打ち、棍棒でなぐりつける。剣のようなくちばしの、ざらざらした刃先を捕まえながら、魚体の色が鏡の裏側のような銀色に変わるまでその頭を打った。それから少年の助けを借りて、魚を船に引き上げた。この間もずっと、オスのカジキは船のそばに留まっていたのだった。老人がすぐにロープを片付けて銛を手に取ると、オスは船の間近で、メスの姿を確認できる高さまで跳ね上がった。そしてそのまま、深く潜って行ってしまった。翼のような胸びれを大きく広げ、薄紫色の縞模様を見せながら。あいつは美しかった。最後まで寄り添ったんだ。",
      ...
      "彼は思った。明るくなったら四〇尋の餌のところに戻って、それも切ってしまおう。そうすれば、そのロープも繋げる。質の良いカタルーニャ製のコルデル（※ロープのこと）を二〇〇尋分と、鉤と鉤素とを失くすことになるな。だが代わりがきく物だ。別の魚を引っ掛けたせいで奴を逃がしたら、その代わりがいるか？　今さっき何の魚が食いついたのか、それは分からん。マカジキかメカジキか、あるいはサメだったかもしれん。引いてもみなかった。確かめるより先に、切り落とさなきゃいけなかったんだ。",
      "彼は声に出して言った。「あの子がいてくれたらなあ」",
      "しかしあの子はいない。彼は思った。いるのはお前一人だ。暗くても構わず、最後のロープを切るのを今やってしまったほうがいい。切ってしまって、控えのロープ二本を繋ぐんだ。",
      "彼は実行した。闇の中では難しい作業だった。一度、魚がうねるように大きく動き、彼は顔から引き倒されて目の下を切った。少しだけ頬に血が流れたが、顎に届く前に固まって乾いてしまった。何とか舳先まで戻り、船板にもたれて休んだ。彼は、肩に当てた袋の位置を調整して、ロープの当たる場所を慎重に変えた。肩で支えるロープから伝わる引き具合を注意深く確かめつつ、片手を水に入れて船の進む速さを測った。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "彼は膝をつき、船尾のマグロのほうに手鉤を伸ばした。そして予備のロープを避けつつマグロを引き寄せる。再びロープを左肩で支え、左の手と腕に力を入れつつ、手鉤の先からマグロを外して、手鉤は元の場所に戻した。片方の膝で魚を押さえる。そして頭の後ろから尾に向かって縦に刃を入れ、赤黒い魚肉を切り出した。くさび形の塊だ。彼はそれを、背骨のそばから腹の方向へ切った。六つの切り身ができると、それを舳先の板の上に並べる。ナイフをズボンで拭き、残った骨の尻尾をつまんで海に投げ捨てた。",
      ...
      "ロープはゆっくり確実に上がってくる。やがて、船の前方の海面がゆらめき、魚が姿を現した。さらに浮上は止まらず、水が体の左右に流れ落ちる。魚は太陽の下で輝いた。頭と背は暗い紫色だ。側面の幅広い縦縞は、光に照らされて明るい薄紫に見えた。くちばしは野球のバットのように長く、剣のように尖っていた。魚は全身を露わにする高さまで水面から跳ねると、ダイバーのように滑らかに、再び潜っていった。老人は大鎌の刃のような尾が沈んでいくのを見た。そしてロープが走り始める。",
      ...
      "老人は楽な姿勢で船べりにもたれ、襲ってくる痛みに耐えた。魚は弛みなく泳ぎ、船は暗い海をゆっくりと進む。東から吹いてきた風で、海面は少し波立っていた。正午には、老人の左手は治った。",
      ...
      "「めでたし、聖寵充ち満てるマリア、主御身と共にまします。御身は女のうちにて祝せられ、御胎内の御子イエズスも祝せられ給う。天主の御母聖マリア、罪人なるわれらのために、今も臨終のときも祈り給え。アーメン」そして付け加えた。「聖母よ、この魚の死のために、祈り給え。素晴らしい魚ですがね」",
      "祈りを唱えていると気分は良くなったが、痛みは変わらず、むしろ少し増したようでもあった。彼は舳先の板にもたれて、特に意識することなく、左手の指を動かし始めた。",
      "穏やかな風が出てきたが、太陽はもう熱い。",
      "「短いロープにまた餌をつけて、船尾から垂らしておいたほうがいいな」彼は言った。「あの魚がもう一晩耐えるつもりなら、また食う必要が出るだろう。水も残り少ない。ここじゃシイラしか釣れないだろうが、活きのいい奴なら不味くはない。今夜あたり、トビウオが船に飛び込んでくれたら有難いな。光も無いのに寄っては来ないだろうが。生で食うトビウオは最高だし、さばく手間も省ける。とにかく力を温存しなけりゃならんからな。畜生、奴があんなにでかいとは思わなかった」",
      ...
      "午後になろうとしていたが、船は変わらずゆっくり着実に移動していた。今は東風が抵抗となって、老人は静かな海を穏やかに進むのだった。背中にまわしたロープの痛みは、和らいで楽になってきた。",
      ...
      "試合の結果が分からなくなってから二日目だな。彼は思った。だが俺は自信を持って、大ディマジオに負けないようにしなければ。大ディマジオは、かかとの骨棘が痛んでも、全て完璧にやれる男だ。骨棘とは何のことだろう。彼は自問した。骨の棘か。俺たちには無い。闘鶏につける蹴爪が、かかとに付いたような痛みだろうか。それは耐えられないな。闘鶏は片目を潰されても、両目とも潰されても闘い続ける奴らだ。立派な鳥や獣に比べれば、人間など大したものじゃない。やっぱり俺は、海の暗闇の中に潜るあの獣になりたい。",
      ...
      "一晩中、形勢は変わり続けた。観衆は黒人に、ラム酒を飲ませたり煙草の火をつけてやったりした。黒人はラム酒を飲むたびに、とてつもない力を振り絞った。一度は、黒人が老人を――当時は老人ではなく王者サンチャゴだったのだが――、老人を三インチ近く押し、均衡を崩した。が、老人は再び全く五分の状態まで押し戻した。その時彼は、この立派な男を、強靭な肉体を持つ黒人を、打ち倒せると確信した。夜明け頃、引き分けにすべきだと賭け手たちが言い出し、審判が首を横に振る中で、彼は、ありったけの力を込めて黒人の腕を傾けていき、テーブルにつくまで倒してしまった。勝負は、日曜の朝に始まり、月曜の朝に終わった。賭け手の多くが引き分けを要求したのは、これから波止場で砂糖袋を積み込むとか、ハバナ石炭会社で勤めるとかの仕事があったためだ。それがなければ、最後まで続けることを誰もが望んだだろう。ともかく彼は、誰も仕事に行かないうちに勝負を終わらせた。",
      ...
      "飛行機に乗ったら、きっと妙な気持ちになるだろうな、と彼は思った。あの高さから、海はどう見えるのか。あまり高いところを飛ばなければ、魚が見えるだろう。二百尋くらいの高さをゆっくり飛んで、上から魚を見てみたい。亀獲り船に乗っていた頃、マストの先の横木によく登ったものだが、そのくらいの高さでもずいぶん見えた。そこからだとシイラは濃い緑色に見えて、縞模様と紫色の斑点も見えるんだ。それに、泳いでいる群れの全体を見渡せる。しかしなぜ、暗い流れの中を素早く泳ぐ魚というのは、どれもみな紫色の背中で、紫色の縞や斑点があるんだろう。シイラは本当は金色だから、もちろん緑色に見えるんだが、ひどく腹をすかせて餌を食う時になると、側面にカジキみたいな紫色の縞が浮き出るんだ。怒りのせいなのか、それとも、普段よりスピードを出すせいなのか。",
      ...
      "やり方が分かってきたようだ、と彼は思った。ひとまずこういう感じだな。考えてみれば奴は、俺の仕掛けに食いついてから何も食ってない。奴の大きさなら、食べ物もたくさん要るはずだ。俺はマグロを丸一匹食べた。明日にはシイラを食べるんだ。老人はシイラを「金色」と呼んだ。腸抜きしたら、少し食っておいたほうがいいだろう。マグロよりは食いにくいな。しかし、まあ、簡単なことなど何も無いんだ。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "彼は考えた。今は、オールを船の足枷にすることを考えなければ。リスクはあるが利点もある。もしも奴が頑張ろうとして、オールの足枷がうまく働いて、船が軽快さを失ったとしたらどうだ。ロープを出し切って、奴を逃がすかもしれない。船が軽快であれば、双方とも苦しみが長引く。だがそちらのほうが安全だ。奴はまだ全力のスピードを出していないんだからな。どうなるにしても、シイラが悪くならないように腸抜きをして、多少は腹に入れておくんだ。力をつけるために。",
      ...
      "俺の頭は十分冴えてる。彼は思った。冴えすぎだ。兄弟分の星たちと同じくらい冴えてる。だが眠らなくては。星も眠るし、月も太陽も眠る。海だって、流れも風も無い凪の時には眠ってるんだ。",
      "眠るのを忘れちゃいけない。彼は思った。ちゃんと眠って、ロープのほうは簡単で確実な方法を何とか考えなきゃいかん。さあ、船尾に戻ってシイラをさばくんだ。眠るなら、オールを船の足枷にするのは危険すぎる。",
      ...
      "船尾に戻ると、肩にまわしたロープを左手で持ち、右手でナイフを鞘から出した。星々が明るく輝き、シイラがはっきりと見える。彼はシイラの頭に刃を突き立て、船尾の陰から引っ張り出した。片足で魚を押さえ、肛門から下顎の先までに手早くナイフを入れる。それからナイフを置いて、右手で腸を抜く。中をきれいにし、エラも取ってしまった。その胃は重く、両手から滑り落ちそうだった。胃を切り開くと、中には二匹のトビウオが入っていた。新鮮で身が締まっている。それを傍らに並べ、内臓とエラは船尾の向こうに放り投げた。燐光を発し、水中に軌跡を描きながら沈んでいく。シイラは冷たく、星の光の下では癩のように灰色に見えた。魚の頭を右足で押さえながら片側の皮を剥ぎ、ひっくり返して、反対側の皮を剥いだ。それから、両側の頭から尾まで刃を入れ、身を切り取った。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "奴のあの槍が、針金の鉤素を叩いているんだ。彼は考えた。当然だ、そうせざるをえまい。だが、その勢いで跳ねられるのは困る。まだ回り続けてほしいところだ。空気を求めて跳ねてしまうんだろうが、跳ねるたびに鉤が引っかかった口の傷が開いてしまう。そのうち鉤を振り捨てられてしまうかもしれない。",
      "「魚よ、跳ねるな」彼は言った。「跳ねるなよ」",
      ...
      "魚には勝手に周回させておき、ロープを引くこともなしに、舳先で休んでいたい。それはとても魅力的な誘惑だった。しかし、魚が大きく回って船に近づいてきていることをロープが示すと、老人は立ち上がった。体を軸として、機織のようにロープを引き始める。彼はロープを手繰れるだけ手繰った。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "老人は眩暈を覚えた。胸がむかむかするし、目はよく見えない。だが彼は、銛のロープの絡みを取り、擦りむけた手でそれを少しずつ送り出した。視界がはっきりしてくると、魚が銀色の腹を出して仰向けになっているのが見えた。銛の柄は魚の体に斜めに突き刺さり、その心臓から流れる血は海を赤く染めていた。一マイル以上の深さの青い海を背景として、魚群のような暗い色の塊になっていた血は、やがて雲のように広がっていった。魚は静かに銀色に輝いて、波に揺られていた。",
      ...
      "魚を船の脇につけるため、彼はロープを引き始めた。鰓から口にロープを通して、頭を舳先に縛り付けるのだ。奴を見ていたいからな、と彼は思った。奴を触って、その感触を確かめたい。奴は俺の財産だ。だが、だから触りたいというわけじゃない。俺は奴の心臓まで感じたんだ。彼は思った。刺さった銛を押し込んだ時にな。さあ、奴をもっと引き寄せて、尾びれと胴体に輪っかをかけて、船に括りつけてやろう。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "魚の真横に船を並べ、舳先をその頭に寄せてみたが、まだ彼はその大きさを信じられなかった。彼は銛に繋がったロープを舳先の棒から外して、それを魚の鰓から顎へと通し、剣のようなくちばしに一回巻いた。それから反対側の鰓に通してさらに一度くちばしに巻き、ロープの端と端を結び合わせて舳先の棒に繋いだ。彼はロープを切り、尻尾のほうにも輪をかけるために船尾に移動した。元々は紫色と銀色だった魚の体は、いまや銀一色に変わっていた。縞模様は尾びれと同じ薄紫色だった。その縞は、指を広げた人間の手よりも幅広い。その眼は、潜望鏡の反射鏡のように、あるいは行列祈祷式の聖者の眼のように、何が映っているのか分からないものだった。",
      ...
      "「鉛筆が要るな」彼は言った。「まだ頭がしっかりしてない。だが今日の俺を見たら、大ディマジオだって褒めるだろう。俺には骨棘は無いが、手や背中はひどい傷だ」骨棘とはどんなものだろうな、と彼は考えた。もしかすると、知らない間にできてるのかもしれない。",
      "魚のロープは船首にも船尾にも腰掛梁にも結ばれた。魚はあまりに大きく、この船より大きな船を横に括りつけたようだった。彼は短く切ったロープで魚の下顎とくちばしを縛った。口を閉じさせておいたほうが、船が滑らかに進むからだ。それから彼はマストを立てる。斜桁と下桁の間に継ぎはぎの帆が張られ、船は動き始めた。彼は船尾で半ば寝そべったまま、南西へ向かった。",
      "コンパスなど必要なかった。貿易風の吹き方と帆の張りを見れば、どちらが南西かは分かる。短いロープに疑似餌をつけて垂らしておこう。食べ物も水分補給も必要だ。しかし、疑似餌は見つからず、イワシは腐っていた。そこで彼は、流れていくホンダワラの黄色い塊を手鉤で引っ掛けた。揺すってみると、中にいた小エビたちが船底に落ちる。十匹以上いるようだ。浜跳虫のように飛び跳ねている。老人は親指と人差し指で頭をつまみ取り、殻や尻尾まで噛み砕いて食べた。とても小さいが、栄養豊富で味も良いことを老人は知っていた。",
      "瓶の中の水はあと二口ほど残っていた。老人はエビを食べてしまった後で、その水を一口の半分だけ飲んだ。重荷のわりに、船はよく進む。彼は舵棒を脇に挟んで操舵を行っていた。魚はすぐそこに見える。自分の手を見て、船尾に寄りかかる背中の感触を意識すれば、これが夢ではなく本当に起きた事だと分かった。闘いの終盤、あまりにも苦しかった時、これは夢かもしれないと彼は思った。そして魚が水から跳ね上がり、落下する前に空中で静止した時には、何かとてつもなく異常なことが起きているとしか思えず、現実と信じることができなかった。その時は目がよく見えなかったのだ。今はもう、何ともないが。",
      ...
      "彼らの船は順調に進んだ。老人は手を塩水に浸し、しっかりした頭を保つよう努めた。空高く積雲が浮かび、その上には巻雲がたくさん出ていたから、風は一晩中やまないと分かった。老人はたびたび魚のほうを見て、それが現実であることを確かめていた。それから一時間。最初のサメが、彼を襲った。",
      ...
      "老人の頭は今、はっきりと明晰だった。決意がみなぎっていた。しかし、望みはほとんど無かった。あまりに良い事は長続きしないものだ、彼はそう思った。近づくサメに注意しながらも、彼は大魚を一瞥する。夢だったら良かった、と彼は思う。襲ってくるのは避けられないが、きっと、倒すことはできる。彼は思った。この畜生、牙野郎め。",
      ...
      "何も知らないし、罪の存在を信じているかどうかも分からない。きっと、魚を殺したのは罪なんだろう。自分が生きるためでも、みんなに食わせるためでも、罪だろうな。だがそれじゃあ全てが罪だ。罪のことなど考えるな。もうずいぶん手遅れだ。それを考えて金を貰ってる奴らに、任せておけばいい。魚が魚に生まれたように、俺は漁師に生まれついたんだ。聖ペドロも漁師だった。大ディマジオの親父も同じだ。",
      ...
      "風は吹き続けている。風向きは、東から少し北東のほうに変わった。つまり、当分はやまないということだ。老人は前方を眺めた。しかし帆影は見えず、船体も見えず、蒸気船の煙も見えなかった。ただ、トビウオが舳先から船の左右に跳ね上がり、ホンダワラの黄色い塊が漂っているだけだ。鳥は一羽も見当たらなかった。",
      ...
      "「それにしても、今の奴にはずいぶん取られた」彼は言った。「しかし船は軽くなったぞ」食いちぎられた半身のことは考えたくなかった。サメがガタガタとぶつかるたび、肉が剥ぎ取られていったのが彼には分かっていた。いまや魚は、海中に匂いで航跡を描き、全てのサメを引き寄せる広い道を作っているかのようだった。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "空に反射する街の光が見えてきたのは、夜の十時頃のことだった。最初はおぼろげで、月が出る前に空が明らんでいるだけのようだったが、やがて、強い風で荒れてきた海を越え、光ははっきりと見えてきた。彼は光のほうへ舵を取って、考えた。もう少ししたら、メキシコ湾流の縁から出られるだろう。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "「気の毒だ。よろしく伝えてくれ」",
      "「ありがとう」少年は言った。",
      "少年は、コーヒーの入った缶を持って小屋へ行き、老人が起きるまでそばに座っていた。老人は一度起きそうな様子を見せた。しかしまた深い眠りへと戻った。少年は通りを渡って、コーヒーを温めるための薪を借りてきた。",
      "とうとう老人は目を覚ました。",
      ...
      "「別のを見つけてくるよ。バネも研いでもらう。このひどい風は、何日続くの？」",
      "「三日くらいだな。もっとかもしれない」",
...
export const credit = {
  work: "本文は、青空文庫収録の石波杏訳『老人と海』（アーネスト・ヘミングウェイ THE OLD MAN AND THE SEA, Jonathan Cape, 1952／2015年7月翻訳公開）を、クリエイティブ・コモンズ 表示 2.1 日本 ライセンスのもとで使用しています。ルビは省略し、訳者あとがき・参考文献一覧はこのページには含めていません。",
  sourceLabel: "青空文庫（底本カード）",
  sourceUrl: "https://www.aozora.gr.jp/cards/001847/card57347.html",
  licenseLabel: "クリエイティブ・コモンズ 表示 2.1 日本 (CC BY 2.1 JP)",
